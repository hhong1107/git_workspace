 ...
 * @date 2013年12月8日
 */
public class PurchaseTest extends AbstractJavaSamplerClient {
	...
	public Arguments getDefaultParameters() {
		...
		conf.setApiUri("tradeorder/purchase/v1");
		...
		params.addArgument("fundCode", "基金代码");
		params.addArgument("shareType", "份额类别(A)");
		params.addArgument("applyAmount", "买入金额");
