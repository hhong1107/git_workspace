 ...
 * @date 2013年12月8日
 */
public class RiskTest extends AbstractJavaSamplerClient {
	...
	public Arguments getDefaultParameters() {
		...
		conf.setApiUri("account/risk/evaluate/v1");
		...
		params.addArgument("riskScore", "风险评测结果(0~35:保守型,36~50:稳健性,51~99分:激进型)");
		return params;
	}
